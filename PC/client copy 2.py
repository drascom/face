...
class SocketClient(QThread):
    ...
    # on demand<-----  talk kısmının orjinali send unutma --->>>>
    def send(self, msg):
        try:
            self.sio.emit('talk', msg)
...
class ChatWindow(QMainWindow, ui_form):
    ...
    def read_values(self, data):
        ...
        print("2 :  ",self.running_function,"3 : ",new_function)
    ...
    def start_function(self, new_function, data=""):
        ...
        print("1 : " ,self.running_function,"2 : ",new_function)
        if self.running_function != new_function:
