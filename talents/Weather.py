from utils import getCity, convertTimestamp, getDayName, is_file_older_than
...
def get_weather():
    ...
    try:
        ...
        # res = res.json()
        json_file = "robot/assets/forecast.json"
...
class Weather:
    def __init__(self, *args):
        ...
        isOlder = is_file_older_than("robot/assets/forecast.json", timedelta(minutes=50)
                                     )
        if isOlder:
        ...
        with open("robot/assets/forecast.json", "r", encoding="utf-8"
                  ) as f:
