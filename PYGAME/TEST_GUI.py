...
# Images
imgBackground = pygame.image.load('assets/img/background.jpg').convert()
imgDesign = pygame.image.load('assets/img/design.png').convert_alpha()
imgIcon1 = pygame.image.load('assets/img/icon1.png').convert_alpha()
imgIcon2 = pygame.image.load('assets/img/icon1.png').convert_alpha()
imgIcon3 = pygame.image.load('assets/img/icon1.png').convert_alpha()
imgIcon4 = pygame.image.load('assets/img/icon1.png').convert_alpha()
imgIcon5 = pygame.image.load('assets/img/icon1.png').convert_alpha()
imgShadow = pygame.image.load('assets/img/icon1.png').convert_alpha()
imgToggleOn = pygame.image.load('assets/img/icon1.png').convert_alpha()
imgToggleOff = pygame.image.load('assets/img/icon1.png').convert_alpha()
...
def drawWindowPad(pos, color, text, icon):
    ...
    # Text
    font = pygame.font.Font('assets/fonts/DroidSans.ttf', 20)
...
def drawFilterPad():
    ...
    # Sliders
    font = pygame.font.Font('assets/fonts/DroidSans.ttf', 25)
    for y in range(0, 3):
        h = 447 + y * 55
