...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.BTN_camera = customtkinter.CTkButton(master=self.frame_left,
                                                  height=15,
                                                  text="Camera",
                                                  border_width=3,   # <- custom border_width
                                                  fg_color=None,   # <- no fg_color
                                                  command=lambda: self.send_command('camera'))
        self.BTN_camera.grid(row=3, column=0, pady=10, padx=20)
        ...
        self.BTN_home.grid(row=4, column=0, pady=10, padx=20)
        ...
        self.BTN_clock.grid(row=5, column=0, pady=10, padx=20)
        ...
        self.BTN_weather.grid(row=6, column=0, pady=10, padx=20)
